								...
								<%-- 	<c:if test="${ p.productStatus == 0 }">关闭</c:if>
									...
									<td class="text-center">
										<button type="button" class="btn bg-olive btn-xs"
											onclick='location.href="${pageContext.request.contextPath}/product/updateProductUI?id=${p.id}"'>修改</button>
										<button type="button" class="btn bg-olive btn-xs"
											onclick='deleteProduct(${p.id})'>删除</button>
									</td>
								</tr>
